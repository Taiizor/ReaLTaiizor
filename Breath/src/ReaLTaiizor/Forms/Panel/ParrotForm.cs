...
namespace ReaLTaiizor.Forms
{
    ...
    public class ParrotForm : System.Windows.Forms.Panel
    {
        ...
        private void RefreshUI()
        {
            ...
            if (formStyle == Style.MacOS)
            {
                System.Windows.Forms.Panel panel3 = new()
                {
                    BackColor = Color.FromArgb(173, 173, 173),
            ...
            if (formStyle == Style.Ubuntu)
            {
                ParrotGradientPanel parrotGradientPanel2 = new ParrotGradientPanel
                {
                    Style = ParrotGradientPanel.GradientStyle.Horizontal,
                    TopLeft = Color.FromArgb(90, 85, 80),
                    TopRight = Color.FromArgb(65, 65, 60),
