...
namespace ReaLTaiizor.Forms
{
    ...
    public class RibbonForm : ContainerControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            ImageToCodeClassRibbon d = new ImageToCodeClassRibbon();
            ...
            Pen p1 = new Pen(new SolidBrush(HeaderLineColorA));
            G.DrawLine(p1, 0, 31, Width, 31);
            Pen p2 = new Pen(new SolidBrush(HeaderLineColorB));
            G.DrawLine(p2, 0, 30, Width, 30);
            G.DrawLine(new Pen(new SolidBrush(HeaderLineColorC)), 0, 32, Width, 32);
            ...
            Pen penCurrent = new Pen(RibbonEdgeColorC);
            G.DrawPolygon(penCurrent, Pt);
            SolidBrush br = new SolidBrush(RibbonEdgeColorD);
            G.FillPolygon(br, Pt);
            ...
            Pen penCurrent2 = new Pen(RibbonEdgeColorE);
            G.DrawPolygon(penCurrent2, Pt2);
            //HatchBrush br2 = new HatchBrush(HatchType, Color.FromArgb(52, 52, 51), Color.FromArgb(48, 49, 48));
            //G.FillPolygon(br2, Pt2);
            G.FillPolygon(TEXTUREIMAGE, Pt2);

            G.DrawLine(new Pen(new SolidBrush(RibbonEdgeColorA)), 10, 0, 10, 66);
            G.DrawLine(new Pen(new SolidBrush(RibbonEdgeColorB)), 10, 66, 36, 40);
            ...
            Pen BottomPen = new Pen(new SolidBrush(BottomLineColor), 7);
