...
namespace ReaLTaiizor.Controls.ControlBox
{
    ...
    public class DungeonControlBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                LinearGradientBrush LGBMaximize = new LinearGradientBrush(MinBtn, Color.FromArgb(130, 129, 123), Color.FromArgb(103, 102, 96), 90);
            ...
            switch (State)
            {
                case MouseState.None:
                    ...
                    {
                        LinearGradientBrush xLGBMaximize = new LinearGradientBrush(MinBtn, Color.FromArgb(130, 129, 123), Color.FromArgb(103, 102, 96), 90);
                ...
                case MouseState.Over:
                    ...
                    else if (X > 23 && X < 40)
                    {
                        ...
                        {
                            LinearGradientBrush xLGBMaximize = new LinearGradientBrush(MinBtn, Color.FromArgb(196, 196, 196), Color.FromArgb(173, 173, 173), 90);
                            G.FillEllipse(xLGBMaximize, MinBtn);
                            G.DrawEllipse(new Pen(Color.FromArgb(57, 56, 53)), MinBtn);
                            G.DrawString("1", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(52, 50, 46)), new Rectangle(26, 7, 0, 0));
                        }
