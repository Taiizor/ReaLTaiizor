...
{
	#region MaterialMenuStrip

	public class MaterialMenuStrip : MenuStrip, MaterialControlI
	{
	...
	internal class MaterialMenuStripRender : ToolStripProfessionalRenderer, MaterialControlI
	{
