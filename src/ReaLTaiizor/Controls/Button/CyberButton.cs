...
namespace ReaLTaiizor.Controls
{
    ...
    public partial class CyberButton : UserControl
    {
        ...
        private ButtonStyle tmp_cyberbutton_style = ButtonStyle.Default;
        [Category("Cyber")]
        [Description("Control style")]
        public ButtonStyle CyberButtonStyle
        {
        ...
        public CyberButton()
        {
            ...
            Tag = "Cyber";
            CyberButtonStyle = ButtonStyle.Default;
            CyberButtonStyle = ButtonStyle.Custom;
