...
{
    #region MetroScrollBarDesignerDesign
    ...
    internal class MetroScrollBarDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists => _actionListCollection ??= [new MetroScrollBarActionList(Component)];
    }
