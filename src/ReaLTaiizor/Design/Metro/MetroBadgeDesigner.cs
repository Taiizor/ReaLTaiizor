...
namespace ReaLTaiizor.Design.Metro
{
    ...
    internal class MetroBadgeDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists => _actionListCollection ?? (_actionListCollection = new DesignerActionListCollection { new MetroBadgeActionList(Component) });
    }
