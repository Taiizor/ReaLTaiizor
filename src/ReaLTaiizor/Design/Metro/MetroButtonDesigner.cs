...
{
    #region MetroButtonDesignerDesign
    ...
    internal class MetroButtonDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists => _actionListCollection ?? (_actionListCollection = new DesignerActionListCollection { new MetroButtonActionList(Component) });
    }
