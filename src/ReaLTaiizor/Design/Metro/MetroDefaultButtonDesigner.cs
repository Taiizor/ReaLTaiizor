...
namespace ReaLTaiizor.Design.Metro
{
    ...
    internal class MetroDefaultButtonDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists => _actionListCollection ??= new DesignerActionListCollection { new MetroDefaultButtonActionList(Component) };
    }
